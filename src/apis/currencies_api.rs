...
pub async fn get_currencies(configuration: &configuration::Configuration, term: Option<&str>) -> Result<crate::models::GetCurrenciesResponse200, Error<GetCurrenciesError>> {

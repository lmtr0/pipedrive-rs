...
pub struct AddActivityResponse200RelatedObjectsOrganizationOrganizationId {
...
impl AddActivityResponse200RelatedObjectsOrganizationOrganizationId {
    /// The ID of the organization associated with the item
    pub fn new() -> AddActivityResponse200RelatedObjectsOrganizationOrganizationId {

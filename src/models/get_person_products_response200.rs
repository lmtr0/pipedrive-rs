...
pub struct GetPersonProductsResponse200 {
    /// If the response is successful or not
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    /// The array of deal products
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetPersonProductsResponse200AllOfDataInner>>,
...
impl GetPersonProductsResponse200 {
    pub fn new() -> GetPersonProductsResponse200 {

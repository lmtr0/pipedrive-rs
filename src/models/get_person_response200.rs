...
pub struct GetPersonResponse200 {
    ...
    pub additional_data: Option<Box<crate::models::GetPersonResponse200AllOfAdditionalData>>,
...
impl GetPersonResponse200 {
    pub fn new() -> GetPersonResponse200 {

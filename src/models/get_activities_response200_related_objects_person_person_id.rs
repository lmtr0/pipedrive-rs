...
pub struct GetActivitiesResponse200RelatedObjectsPersonPersonId {
...
impl GetActivitiesResponse200RelatedObjectsPersonPersonId {
    /// The ID of the person associated with the item
    pub fn new() -> GetActivitiesResponse200RelatedObjectsPersonPersonId {
        GetActivitiesResponse200RelatedObjectsPersonPersonId {
            id: None,
            name: None,
            email: None,
            phone: None,

...
pub struct GetOrganizationsResponse200AllOfRelatedObjectsPicturePictureId {
...
impl GetOrganizationsResponse200AllOfRelatedObjectsPicturePictureId {
    /// The ID of the picture
    pub fn new() -> GetOrganizationsResponse200AllOfRelatedObjectsPicturePictureId {
